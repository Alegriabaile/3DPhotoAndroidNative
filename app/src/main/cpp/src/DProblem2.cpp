...
int DProblem2::point_transfer(const cv::Vec3f& point0, const cv::Vec3f& rvec, const cv::Vec3f& tvec, cv::Vec3f& point1)
{
...
int DProblem2::depth_transfer(const double * const scales, const double * const offsets, cv::Mat& depth)
{
...
int DProblem2::updateParameters(std::vector<i3d::Frame> & kframes)
{
    //更新模型矩阵
...
DProblem2::DProblem2(std::vector<i3d::Frame> &kframes, std::vector<i3d::Edge> &kedges,
...
int DProblem2::initParameters(const std::vector<i3d::Frame> &kframes,
