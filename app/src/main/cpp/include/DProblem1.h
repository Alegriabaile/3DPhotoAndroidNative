...
#ifndef I3D_DPROBLEM1_H
#define I3D_DPROBLEM1_H

//align the depth
////////////////////////// d' = 1/(scale*(1/d)+offset)
...
{
public:
    DProblem1(std::vector<i3d::Frame> & kframes, std::vector<i3d::Edge> & kedges,
